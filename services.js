...
let phoneHelper = document.getElementById("helper-text");

togglePopup(phoneInput, phoneLabel)

// ---------- ESCOLHA HORÁRIO ---------- //
let senhaInput = document.getElementById("appt");
let senhaLabel = document.querySelector('label[for="appt"]');
